...
class TestLifecycleHandler(unittest.TestCase):
    ...
    def get_hanlde_failures_transition_config(self):
        return [
            {
                'source': 'pending',
                'dest': 'ignore_before',
            ...
            {
                'source': 'failure_with_no_failure',
                'dest': 'failure_with_failure',
                'triggers': [
                    {
                        'name': 'failure_2',
                        'before': [self.trigger_no_error],
